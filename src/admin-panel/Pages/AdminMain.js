...
class AdminMain extends Component {
    ...
    fetchRequests = async () => {
        try {
            const response = await fetch('https://suzdal-gymnazia-v2.onrender.com/api/feedback');
    ...
    handleMarkProcessed = async (id) => {
        try {
            const response = await fetch(`https://suzdal-gymnazia-v2.onrender.com/api/feedback/${id}`, {
                method: 'DELETE'
            });
            if (!response.ok) throw new Error();
            this.fetchRequests();
    ...
    fetchPasswordRequests = async () => {
        try {
            const response = await fetch('https://suzdal-gymnazia-v2.onrender.com/api/password-requests');
            if (!response.ok) throw new Error();
            const data = await response.json();
